...
public class DoExercisesHandler : MonoBehaviour
{
    ...
    public void viewExercise (Exercise exer) {
        ...
        gameObject.GetComponent<ExerciseController>().setExerciseAndStart(exer);
    ...
    void renderPagination () {
        ...
        for (int i = index; i < max; i++) {
            ...
            ej.GetComponent<ViewExercisesHanderDo> ().loadExercise (exer);
            ej.SetActive (true);
